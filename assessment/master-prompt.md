...
1. **The Assessment** — a 70 to 90 question survey that scores a client across six pillars from one set of answers. Many questions multi-score across pillars to keep the experience tight (target completion: 12 to 18 minutes).
...
Tell me: "Generate a sample [Solo / Linked Pair / Family] report for a [scenario description]. Make up plausible scores across all six pillars for each person."
