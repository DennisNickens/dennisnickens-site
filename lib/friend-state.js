...
// 72 cards are all tagged depth='real'). 'light' and 'deep' are shown in
// the picker as "Coming soon" until their content batches drop in later
// deploys. The valid_depths array is the source of truth for what UI
// surfaces but only 'real' is selectable for now.
var VALID_DEPTHS = ['light', 'real', 'deep'];
var SELECTABLE_DEPTHS = ['real', 'deep'];
...
// Only depths in SELECTABLE_DEPTHS are accepted; 'light' and 'deep' return
// depth_coming_soon until their content batches ship.
